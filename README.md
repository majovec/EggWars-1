...
| ![Download icon](https://storage.googleapis.com/material-icons/external-assets/v4/icons/svg/ic_file_download_black_18px.svg) | Twitter | Travis CI | Discord |
| :---: | :---: | :---: | :---: || 
) PHAR | 
| [![Download](https://img.shields.io/badge/download-latest-blue.svg)](https://jenkins.zxda.net/job/Turanic/lastSuccessfulBuild/artifact/plugins/FServerPacker/Turanic_1.2.5_3.0.1.phar) |
